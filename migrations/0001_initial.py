# Generated by Django 3.0.3 on 2021-01-07 15:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(null=True, storage=django.core.files.storage.FileSystemStorage(base_url='/api/django_filemanager/media_files/', location='/personal_files'), upload_to=formula_one.utils.upload_to.UploadTo('', 'filemanager_logos', file_manager=False))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upload', models.FileField(max_length=1000000, storage=django.core.files.storage.FileSystemStorage(base_url='/api/django_filemanager/media_files/', location='/network_storage'), upload_to=django_filemanager.upload_to.UploadTo('', '', file_manager=True))),
                ('permission', models.CharField(choices=[('_', 'FORBIDDEN'), ('r_o', 'READ_ONLY'), ('w_o', 'WRITE_ONLY'), ('r_w', 'READ_AND_WRITE')], default='r_o', max_length=10)),
                ('starred', models.BooleanField(default=False)),
